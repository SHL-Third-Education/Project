// -------------------------------------------------------------
// 
// File Name: /tmp/tpc580e839_93cc_49a5_b11d_c2360b776e0b/hdlcoder_dspprogfir/Programmable_FIR_via_Registers.v
...
// Source Path: hdlcoder_dspprogfir/Programmable FIR via Registers
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Programmable_FIR_via_Registers
  ...
  always @(posedge clk or posedge reset)
    begin : shadow_regs_process
      if (reset == 1'b1) begin
        coeffs_shadow[0] <= 14'sb00000000000000;
        coeffs_shadow[1] <= 14'sb00000000000000;
        coeffs_shadow[2] <= 14'sb00000000000000;
        coeffs_shadow[3] <= 14'sb00000000000000;
        coeffs_shadow[4] <= 14'sb00000000000000;
        coeffs_shadow[5] <= 14'sb00000000000000;
        coeffs_shadow[6] <= 14'sb00000000000000;
        coeffs_shadow[7] <= 14'sb00000000000000;
        coeffs_shadow[8] <= 14'sb00000000000000;
        coeffs_shadow[9] <= 14'sb00000000000000;
        coeffs_shadow[10] <= 14'sb00000000000000;
        coeffs_shadow[11] <= 14'sb00000000000000;
        coeffs_shadow[12] <= 14'sb00000000000000;
        coeffs_shadow[13] <= 14'sb00000000000000;
        coeffs_shadow[14] <= 14'sb00000000000000;
        coeffs_shadow[15] <= 14'sb00000000000000;
        coeffs_shadow[16] <= 14'sb00000000000000;
        coeffs_shadow[17] <= 14'sb00000000000000;
        coeffs_shadow[18] <= 14'sb00000000000000;
        coeffs_shadow[19] <= 14'sb00000000000000;
        coeffs_shadow[20] <= 14'sb00000000000000;
        coeffs_shadow[21] <= 14'sb00000000000000;
        coeffs_shadow[22] <= 14'sb00000000000000;
        coeffs_shadow[23] <= 14'sb00000000000000;
        coeffs_shadow[24] <= 14'sb00000000000000;
        coeffs_shadow[25] <= 14'sb00000000000000;
        coeffs_shadow[26] <= 14'sb00000000000000;
        coeffs_shadow[27] <= 14'sb00000000000000;
        coeffs_shadow[28] <= 14'sb00000000000000;
        coeffs_shadow[29] <= 14'sb00000000000000;
        coeffs_shadow[30] <= 14'sb00000000000000;
        coeffs_shadow[31] <= 14'sb00000000000000;
        coeffs_shadow[32] <= 14'sb00000000000000;
        coeffs_shadow[33] <= 14'sb00000000000000;
        coeffs_shadow[34] <= 14'sb00000000000000;
        coeffs_shadow[35] <= 14'sb00000000000000;
        coeffs_shadow[36] <= 14'sb00000000000000;
        coeffs_shadow[37] <= 14'sb00000000000000;
        coeffs_shadow[38] <= 14'sb00000000000000;
        coeffs_shadow[39] <= 14'sb00000000000000;
        coeffs_shadow[40] <= 14'sb00000000000000;
        coeffs_shadow[41] <= 14'sb00000000000000;
        coeffs_shadow[42] <= 14'sb00000000000000;
      end
      else begin
        if (enb && write_done) begin
          coeffs_shadow[0] <= coeffs_registers_out1[0];
          coeffs_shadow[1] <= coeffs_registers_out1[1];
          coeffs_shadow[2] <= coeffs_registers_out1[2];
          coeffs_shadow[3] <= coeffs_registers_out1[3];
          coeffs_shadow[4] <= coeffs_registers_out1[4];
          coeffs_shadow[5] <= coeffs_registers_out1[5];
          coeffs_shadow[6] <= coeffs_registers_out1[6];
          coeffs_shadow[7] <= coeffs_registers_out1[7];
          coeffs_shadow[8] <= coeffs_registers_out1[8];
          coeffs_shadow[9] <= coeffs_registers_out1[9];
          coeffs_shadow[10] <= coeffs_registers_out1[10];
          coeffs_shadow[11] <= coeffs_registers_out1[11];
          coeffs_shadow[12] <= coeffs_registers_out1[12];
          coeffs_shadow[13] <= coeffs_registers_out1[13];
          coeffs_shadow[14] <= coeffs_registers_out1[14];
          coeffs_shadow[15] <= coeffs_registers_out1[15];
          coeffs_shadow[16] <= coeffs_registers_out1[16];
          coeffs_shadow[17] <= coeffs_registers_out1[17];
          coeffs_shadow[18] <= coeffs_registers_out1[18];
          coeffs_shadow[19] <= coeffs_registers_out1[19];
          coeffs_shadow[20] <= coeffs_registers_out1[20];
          coeffs_shadow[21] <= coeffs_registers_out1[21];
          coeffs_shadow[22] <= coeffs_registers_out1[22];
          coeffs_shadow[23] <= coeffs_registers_out1[23];
          coeffs_shadow[24] <= coeffs_registers_out1[24];
          coeffs_shadow[25] <= coeffs_registers_out1[25];
          coeffs_shadow[26] <= coeffs_registers_out1[26];
          coeffs_shadow[27] <= coeffs_registers_out1[27];
          coeffs_shadow[28] <= coeffs_registers_out1[28];
          coeffs_shadow[29] <= coeffs_registers_out1[29];
          coeffs_shadow[30] <= coeffs_registers_out1[30];
          coeffs_shadow[31] <= coeffs_registers_out1[31];
          coeffs_shadow[32] <= coeffs_registers_out1[32];
          coeffs_shadow[33] <= coeffs_registers_out1[33];
          coeffs_shadow[34] <= coeffs_registers_out1[34];
          coeffs_shadow[35] <= coeffs_registers_out1[35];
          coeffs_shadow[36] <= coeffs_registers_out1[36];
          coeffs_shadow[37] <= coeffs_registers_out1[37];
          coeffs_shadow[38] <= coeffs_registers_out1[38];
          coeffs_shadow[39] <= coeffs_registers_out1[39];
          coeffs_shadow[40] <= coeffs_registers_out1[40];
          coeffs_shadow[41] <= coeffs_registers_out1[41];
          coeffs_shadow[42] <= coeffs_registers_out1[42];
        end
      end
    end
